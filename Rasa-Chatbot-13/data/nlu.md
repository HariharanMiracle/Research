...
## intent:inform
- fix appointment [1](appointmentSlotId)
- appointment [1](appointmentSlotId)
- appointment [1](appointmentSlotId) ok
- number [1](appointmentSlotId)
- number [1](appointmentSlotId) ok
- app [1](appointmentSlotId)
- app [1](appointmentSlotId) ok
- book app [1](appointmentSlotId)
- book appointment [1](appointmentSlotId)
<!-- Specialization -->
