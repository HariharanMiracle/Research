...
class first_aid_tip_form(FormAction):
    ...
    def submit(self,
        ...
        url = "https://21f75e832aa1.ngrok.io/instructions"
        ...
        reply = 'Here you go '
        if (json_data["instructions"]):
            reply = reply + json_data["instructions"]
        else:
            reply = reply + "not found"



        message = "First aid step: {}".format(reply)
...
class specialization_form(FormAction):
    ...
    def submit(self,
        ...
        url = "https://21f75e832aa1.ngrok.io/specializations"
        ...
        reply = 'Here you go '
        if (json_data["specialization"]):
            reply = reply + json_data["specialization"]
        else:
            reply = reply + "not found"



        message = "Specialization: {}".format(reply)
        # message = "First aid tip for {} is {}".format(button_name, results.text)
