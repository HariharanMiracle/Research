...
#     full_path = "https://d0259b50553a.ngrok.io/instructions"
          
#     print("Full path:")
#     print(full_path)
#     results = requests.post(full_path, data={'input': cause})
#     return results
...
class User_details_form(FormAction):
    ...
    def required_slots(tracker: Tracker) -> List[Text]:
        ...
        return ["name", "contact_number", "email_address", "nic", "credit_card", "cvv"]
...
class first_aid_tip_form(FormAction):
    ...
    def submit(self,
        ...
        # message = "First aid tip for {} is {}".format(button_name, results['data'])
